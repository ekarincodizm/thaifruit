                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                ...
                                'child' => function($url, $data, $index) {
                                    $options = array_merge([
                                        'title' => Yii::t('yii', 'Child'),
                                        'aria-label' => Yii::t('yii', 'Child'),
                                        //'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
                                        //'data-method' => 'post',
                                        //'data-pjax' => '0',
                                        'onclick'=>'recDelete($(this));'
                                    ]);
                                    return Html::a('<span class="fa fa-sitemap btn btn-xs btn-default"></span>', 'javascript:void(0)', $options);
                                },
                                'priv' => function($url, $data, $index) {
                                    $options = array_merge([
                                        'title' => Yii::t('yii', 'Privilage'),
                                        'aria-label' => Yii::t('yii', 'Privilage'),
                                        //'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
                                        //'data-method' => 'post',
                                        //'data-pjax' => '0',
                                        'onclick'=>'recDelete($(this));'
                                    ]);
                                    return Html::a('<span class="fa fa-bolt btn btn-xs btn-default"></span>', 'javascript:void(0)', $options);
                                },
